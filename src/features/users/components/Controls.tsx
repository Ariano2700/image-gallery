    ...
    <div className="flex flex-col gap-1 min-w-full">
      <div className={`${controlsCss.controls}`}>
        <svg
          ...
          height="20"
          width="24"
          className={`${controlsCss.volume_button}`}
        >
          <path
            clipRule="evenodd"
        ...
        <div className={`${controlsCss.volume}`}>
          <div className={`${controlsCss.slider}`}>
            <div className={`${controlsCss.green}`}></div>
          </div>
          <div className={`${controlsCss.circle}`}></div>
        </div>
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 24 24"
        ...
        <div className={`${controlsCss.air}`}></div>
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 24 24"
          strokeWidth="2"
      ...
      <div className={`${controlsCss.song_time}`}>
        <p className={`${controlsCss.timetext} ${controlsCss.time_now}`}>
          1:31
        </p>
        <div className={`${controlsCss.time}`}>
          <div className={`${controlsCss.elapsed}`}></div>
        </div>
        <p className={`${controlsCss.timetext} ${controlsCss.time_full}`}>
          3:46
        </p>
      </div>
    </div>
